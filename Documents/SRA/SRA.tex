...
Der Besucher der Website hat vollen Zugriff auf den öffentlichen Bereich. Außerdem ist er in der Lage sich als Tutor, Schüler oder Admin anzumelden. Zur Anmeldung des Schülers und Tutors ist eine erfolgreiche Registrierung erforderlich.
\fbox{\includegraphics[page=1, width=0.98\textwidth]{./Source/YWEE_Kontextdiagramm.pdf}}
\subsection{Kontextdiagramm Tutor/Schüler/Admin}
\fbox{\includegraphics[page=2, width=0.98\textwidth]{./Source/YWEE_Kontextdiagramm.pdf}}
Angemeldete Benutzer hingegen haben erweiterte Zugriffsrechte auf folgende Funktionen: 
