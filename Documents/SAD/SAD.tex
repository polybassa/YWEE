...
\begin{table}[!h]
	...
	\hline
	1.1 & 07.05.2014 & AS & Verbesserung & Missing Data added:  \newline Sequencediagram, Annahmen \\
	\hline
	\text{ } & \text{ } & \text{ } & \text{ } & \text{ } \\
	\hline
	\text{ } & \text{ } & \text{ } & \text{ } & \text{ } \\
...
\caption{Dieses Kontextdiagramm beschreibt die Funktionen, die ein eingeloggter Administrator ausführen kann. Des Weiteren sind die Funktionen auf einzelne Unterfunktionen aufgeschlüsselt.}
\end{figure}
\newpage
...
\begin{figure}[!htbp]
\fbox{\includegraphics[width=0.91\textheight, angle=-90]{./Source/sequence_diagram.png}}  
...
wird nachgereicht
\begin{figure}[!htbp]
\fbox{\includegraphics[width=0.9\textwidth]{./Source/Activity.pdf}} 
\caption{2-3 Sätze was man hier sieht!!}
\end{figure}
\newpage
\section{Objectives} 
...
\begin{table}[!h]
	...
	\hline
	SAD & 16.04.14 & 07.05.14 & In Arbeit & \\
	\hline
