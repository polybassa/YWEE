...
\subsection*{F26: Nachrichten schreiben}
Der Administrator hat die M�glichkeit auf der News Seite neue Nachrichten zu schreiben. Diese werden in der Datenbank gespeichert und f�r alle sichtbar (auch f�r nicht angemeldete User). Der Admin hat au�erdem die M�glichkeit per Adminverwaltung nicht mehr ben�tigte Nachrichten zu l�schen.
