...
START TRANSACTION;
USE `DB1695063`;
INSERT INTO `DB1695063`.`gaestebuch` (`id`, `eintrag`, `benutzername`, `autorisiert`) VALUES (1, 'Dank Die Tutoren Agentur hat sich meine Note in Deutsch von einer 5 auf eine 2 verbessert', 'karlos18', 1);
INSERT INTO `DB1695063`.`gaestebuch` (`id`, `eintrag`, `benutzername`, `autorisiert`) VALUES (2, 'Dank Die Tutoren Agentur kann mein Sohn jetzt auch bis 10 zählen', 'Harry', 1);
INSERT INTO `DB1695063`.`gaestebuch` (`id`, `eintrag`, `benutzername`, `autorisiert`) VALUES (3, 'Ich kann meinen Namen jetzt auch schreiben', 'Anon', 2);
INSERT INTO `DB1695063`.`gaestebuch` (`id`, `eintrag`, `benutzername`, `autorisiert`) VALUES (4, 'Sau geile Seite habt ihr da!', 'EinUser', 1);
INSERT INTO `DB1695063`.`gaestebuch` (`id`, `eintrag`, `benutzername`, `autorisiert`) VALUES (5, 'Totaler Schrott, es gibt keinen in meinem Dorf!', 'Hans', 0);
INSERT INTO `DB1695063`.`gaestebuch` (`id`, `eintrag`, `benutzername`, `autorisiert`) VALUES (6, 'Ich werde es jedem meiner Freunde weiterempfehlen!', 'Intelligenzbolzen', 2);
INSERT INTO `DB1695063`.`gaestebuch` (`id`, `eintrag`, `benutzername`, `autorisiert`) VALUES (7, 'Der letzte Tutor konnte weniger als ich, nie wieder!', 'Urmel', 0);
INSERT INTO `DB1695063`.`gaestebuch` (`id`, `eintrag`, `benutzername`, `autorisiert`) VALUES (8, 'Einfach nur genial!', 'koopie', 1);
INSERT INTO `DB1695063`.`gaestebuch` (`id`, `eintrag`, `benutzername`, `autorisiert`) VALUES (9, 'So schnell hab ich noch nie einen passenden Tutor gefunden, danke!', 'Matheniete', 2);
INSERT INTO `DB1695063`.`gaestebuch` (`id`, `eintrag`, `benutzername`, `autorisiert`) VALUES (10, 'lol', 'ROFL', 0);
INSERT INTO `DB1695063`.`gaestebuch` (`id`, `eintrag`, `benutzername`, `autorisiert`) VALUES (11, 'Spam Attack! hihih', 'h4x0r', 0);
INSERT INTO `DB1695063`.`gaestebuch` (`id`, `eintrag`, `benutzername`, `autorisiert`) VALUES (12, 'Toller Dienst und dann auch noch komplett kostenlos! Echt Super!', 'Susi', 2);
INSERT INTO `DB1695063`.`gaestebuch` (`id`, `eintrag`, `benutzername`, `autorisiert`) VALUES (13, 'Was will man mehr!', 'Nadine', 1);
INSERT INTO `DB1695063`.`gaestebuch` (`id`, `eintrag`, `benutzername`, `autorisiert`) VALUES (14, 'Besser als alle anderen Seite, diese Begeisterungsmerkmale hier!!! Der Wahnsinn!', 'John', 2);
INSERT INTO `DB1695063`.`gaestebuch` (`id`, `eintrag`, `benutzername`, `autorisiert`) VALUES (15, 'Ich komme immer wieder gerne!', 'Manny', 1);
INSERT INTO `DB1695063`.`gaestebuch` (`id`, `eintrag`, `benutzername`, `autorisiert`) VALUES (16, 'Kaufen Sie jetzt Viagra auf www.viagra-fuer-dich.de sie werden es nicht bereuen!', 'Ratiopharm', 0);
INSERT INTO `DB1695063`.`gaestebuch` (`id`, `eintrag`, `benutzername`, `autorisiert`) VALUES (17, 'Das ist schlicht und ergreifend die beste Seite, das kann man klipp und klar sagen.', 'Brot', 2);
INSERT INTO `DB1695063`.`gaestebuch` (`id`, `eintrag`, `benutzername`, `autorisiert`) VALUES (18, 'Frauen in deiner Nachbarschaft auf www.nachbar-spanner.eu', 'Perversling', 0);
INSERT INTO `DB1695063`.`gaestebuch` (`id`, `eintrag`, `benutzername`, `autorisiert`) VALUES (19, 'Medikamente zum halben Preis! WOW! Schau auf www.medis-for-half.com vorbei!', 'Pharmaboy', 0);
INSERT INTO `DB1695063`.`gaestebuch` (`id`, `eintrag`, `benutzername`, `autorisiert`) VALUES (20, 'Garantiert ohne Nebenwirkungen, die Hämorrhoiden-creme ihres vertrauens - Hemocreme!', 'Seriös', 0);
...
INSERT INTO `DB1695063`.`tutoren` (`benutzername`, `umkreis`, `stundenlohn`) VALUES ('Pinky', 5, 10);
INSERT INTO `DB1695063`.`tutoren` (`benutzername`, `umkreis`, `stundenlohn`) VALUES ('admin', 15, 12);
INSERT INTO `DB1695063`.`tutoren` (`benutzername`, `umkreis`, `stundenlohn`) VALUES ('batman', 7, 14);
INSERT INTO `DB1695063`.`tutoren` (`benutzername`, `umkreis`, `stundenlohn`) VALUES ('IQ0', 0, 7);
INSERT INTO `DB1695063`.`tutoren` (`benutzername`, `umkreis`, `stundenlohn`) VALUES ('kitty', 2, 17);
...
INSERT INTO `DB1695063`.`leistung` (`benutzername`, `fach`, `stufen`) VALUES ('heisenberg', 'Biologie', 8);
...
INSERT INTO `DB1695063`.`leistung` (`benutzername`, `fach`, `stufen`) VALUES ('superman', 'Biologie', 10);
...
INSERT INTO `DB1695063`.`leistung` (`benutzername`, `fach`, `stufen`) VALUES ('Schafkopf', 'Biologie', 5);
...
INSERT INTO `DB1695063`.`leistung` (`benutzername`, `fach`, `stufen`) VALUES ('Rambo', 'Biologie', 0);
INSERT INTO `DB1695063`.`leistung` (`benutzername`, `fach`, `stufen`) VALUES ('Anita', 'Deutsch', 0);
INSERT INTO `DB1695063`.`leistung` (`benutzername`, `fach`, `stufen`) VALUES ('Anita', 'Biologie', 0);
...
INSERT INTO `DB1695063`.`leistung` (`benutzername`, `fach`, `stufen`) VALUES ('Pinky', 'Biologie', 9);
INSERT INTO `DB1695063`.`leistung` (`benutzername`, `fach`, `stufen`) VALUES ('admin', 'Biologie', 9);
INSERT INTO `DB1695063`.`leistung` (`benutzername`, `fach`, `stufen`) VALUES ('batman', 'Biologie', 9);
INSERT INTO `DB1695063`.`leistung` (`benutzername`, `fach`, `stufen`) VALUES ('IQ0', 'Biologie', 9);
INSERT INTO `DB1695063`.`leistung` (`benutzername`, `fach`, `stufen`) VALUES ('kitty', 'Biologie', 9);
