...
START TRANSACTION;
USE `pts`;
INSERT INTO `pts`.`mitglieder` (`benutzername`, `geschlecht`, `vorname`, `nachname`, `geburtsdatum`, `wohnort`, `strasse`, `hausnummer`, `hnrzusatz`, `email`, `telefon`, `handy`, `sprache`) VALUES ('admin', 1, 'Daniel', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'deutsch');
