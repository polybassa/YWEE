...
-- -----------------------------------------------------
-- Table `DB1695063`.`nachrichten`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `DB1695063`.`nachrichten` ;

CREATE TABLE IF NOT EXISTS `DB1695063`.`nachrichten` (
...
-- -----------------------------------------------------
-- Table `DB1695063`.`verfuegbarkeit`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `DB1695063`.`verfuegbarkeit` ;

CREATE TABLE IF NOT EXISTS `DB1695063`.`verfuegbarkeit` (
  `benutzername` VARCHAR(20) NOT NULL,
...
-- -----------------------------------------------------
-- Table `DB1695063`.`schwarzesbrett`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `DB1695063`.`schwarzesbrett` ;

CREATE TABLE IF NOT EXISTS `DB1695063`.`schwarzesbrett` (
  `benutzername` VARCHAR(45) NOT NULL,
  `zeit` DATETIME NOT NULL,
  `nachricht` TEXT NOT NULL,
...
-- -----------------------------------------------------
-- Table `DB1695063`.`mentee`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `DB1695063`.`mentee` ;

CREATE TABLE IF NOT EXISTS `DB1695063`.`mentee` (
  `benutzername` VARCHAR(20) NOT NULL,
