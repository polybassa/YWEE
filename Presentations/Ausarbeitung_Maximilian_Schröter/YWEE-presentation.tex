...
\pdfinfo
{
  ...
  /Creator     (TeX)
  /Author      (Schröter Maximilian -- Gruppe 2)
}

\title{YWEE}
\subtitle{Personal Tutoring Service \\ Gruppe 2}
\author{Schröter Maximilian}
\author{Weiß \and Tatzel \and Strobl \and Schwindl \and Laufenböck  \and Birnthaler \and \textbf{Maximilian Schröter} \and Götz}
\newcommand{\autor}{Maximilian Schröter}
\date{02. Juli 2014}
