<?php
    ...
    $titel = "unternehmen"; // Name der Seite die im Browser angezeigt werden soll
    ...
    include_once($_SERVER["DOCUMENT_ROOT"] . "/test_02/de/content/unternehmen.html");       // Inkludiert den Inhalt
