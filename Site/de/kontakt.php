<?php
    ...
    $titel = "Kontakt"; // Name der Seite die im Browser angezeigt werden soll
    ...
    include_once($_SERVER["DOCUMENT_ROOT"] . "/test_02/de/content/kontakt.html");       // Inkludiert den Inhalt
