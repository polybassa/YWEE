<?php
    ...
    if ( !isset( $_SESSION['sprache'] ) )
        include_once($_SERVER["DOCUMENT_ROOT"] . "/de/impressum.html");       // Inkludiert den deutschen Inhalt
    else
        include_once($_SERVER["DOCUMENT_ROOT"] . "/en/impressum.html");       // Inkludiert den englischen Inhalt
