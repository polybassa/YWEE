<?php
    ...
    $titel = "corporate"; // Name der Seite die im Browser angezeigt werden soll
    ...
    include_once($_SERVER["DOCUMENT_ROOT"] . "/test_02/en/content/corporate.html");       // Inkludiert den Inhalt
