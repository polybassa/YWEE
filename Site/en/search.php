<?php
    ...
    $titel = "Enhanced Search"; // Name der Seite die im Browser angezeigt werden soll
    ...
    include_once($_SERVER["DOCUMENT_ROOT"] . "/test_02/en/content/search.html");       // Inkludiert den Inhalt
