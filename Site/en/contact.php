<?php
	...
	// Geändert von: Alexander Strobl
    include_once($_SERVER["DOCUMENT_ROOT"] . "/test_02/scripts/session.php");       // Inkludiert die Session

    $titel = "Contact"; // Name der Seite die im Browser angezeigt werden soll
    ...
    include_once($_SERVER["DOCUMENT_ROOT"] . "/test_02/en/content/contact.html");       // Inkludiert den Inhalt
