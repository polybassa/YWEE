<?php
    ...
    $titel = "Terms and Conditions"; // Name der Seite die im Browser angezeigt werden soll
    ...
    include_once($_SERVER["DOCUMENT_ROOT"] . "/test_02/en/content/termsandconditions.html");       // Inkludiert den Inhalt
